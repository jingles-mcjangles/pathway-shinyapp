...
dash.sidebar <- dashboardSidebar(width = 320,
                                 ...
                                 sidebarMenu(id="sidebarmenu", startExpanded=T, 
                                             ...
                                             # sliderInput("fdr_num", "Flase Discovery Rate", min=0, max=1.0, step=0.01, value=0.05, width = '95%'),
                                             numericInput("fdr_num", "False Discovery Rate", value=0.05, min=0, max=1.0, step=0.01, width="95%"),
